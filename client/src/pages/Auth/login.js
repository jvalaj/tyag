                ...
                <div className="w-full md:w-[60%] flex flex-col my-auto items-center justify-center px-6 py-8 mx-auto ">
                    ...
                    <div className="w-full rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0 bg-white border-gray-300">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            <h1 className="text-xl block text-center font-bold leading-tight tracking-tight md:text-2xl text-">
                            ...
                            <form className="space-y-4 md:space-y-5" onSubmit={handleSubmit} >
                                ...
                                <button type="submit" className="w-full text- bg-white hover:bg-gray-300 transition shadow-xl font-medium rounded-lg text-sm px-5 py-2.5 text-center border border-gray-400">Login</button>


                                <p className="text-sm block text-center font-light text-gray-600">
