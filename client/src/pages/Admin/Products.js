                    ...
                    <div className="bg-gray-300 min-h-[60vh] pr-4 rounded-lg mt-3 sm:mt-0 sm:ml-4 p-2">
                        ...
                        <div className='flex gap-2 m-1 flex-wrap'>
                            {products.map((p) => (
                                ...
                                >
                                    <div className="w-[13rem] overflow-hidden grid grid-rows-2 h-[18rem] border rounded-lg shadow bg-gray-800 border-gray-700">

                                        <div className='row-span-1  bg-white  rounded-t-lg overflow-hidden pb-2'>
                                            <img className=" object-contain h-[9rem] w-full rounded-t-lg" src={`/api/v1/product/product-photo/${p._id}`} alt="photo" />

                                        </div>

                                        <div className=" row-span-1 grid px-2 pt-2 pb-3 sm:pb-6 grid-rows-4  ">
                                            ...
                                            <div className='row-span-1  flex justify-between pt-2 sm:pt-3'>
                                                <p className="text-xs sm:text-sm font-semibold text-right my-auto border border-violet-500 rounded-full px-2 p-1 text-violet-500">{p.category.name}</p>
